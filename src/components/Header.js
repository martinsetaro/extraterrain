...
export default function Header() {
  return (
    <div className='w-full h-[8rem] bg-marino flex '>
      <div className='w-1/2 flex ml-8 p-4'>
        <Image src={logo} alt="logo" width={110} height={90}/>
      </div>
      <nav className='w-1/2 text-white flex gap-8 font-changa items-center justify-end mr-[6rem] text-2xl'> 
